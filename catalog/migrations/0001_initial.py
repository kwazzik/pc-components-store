# Generated by Django 5.2.7 on 2025-10-06 01:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employees', to='catalog.brand')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('managers', models.ManyToManyField(related_name='products', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
